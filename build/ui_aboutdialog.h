...
public:
    ...
    QLabel *label_Snowballs_copyright;
    QLabel *label_2;
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        label_Snowballs_copyright = new QLabel(AboutDialog);
        label_Snowballs_copyright->setObjectName(QString::fromUtf8("label_Snowballs_copyright"));
        label_Snowballs_copyright->setWordWrap(true);
        label_Snowballs_copyright->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        verticalLayout_2->addWidget(label_Snowballs_copyright);
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Snowballs", 0, QApplication::UnicodeUTF8));
        label_4->setText(QString());
        label->setText(QApplication::translate("AboutDialog", "<b>Snowballs</b> version", 0, QApplication::UnicodeUTF8));
        label_Snowballs_copyright->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2014 Snowballs Developers", 0, QApplication::UnicodeUTF8));
